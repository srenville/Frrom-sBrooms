 ...
 * @author Toozigba
 */
public class OrdersXml extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
                                  ...
                                  URL xsltURL = this.getClass().getClassLoader().getResource("showOrdersXml.xsl");
...
Source xmlSource = new StreamSource(xmlURL.openStream(),
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrdersXml.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
