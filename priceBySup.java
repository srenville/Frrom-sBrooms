 ...
 * @author Toozigba
 */
public class priceBySup extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet priceBySup</title>");            
            out.println("</head>");
            out.println("<body>");
            RequestDispatcher index = request.getRequestDispatcher("index.html");
            index.include(request, response);

                URL xsltURL = this.getClass().getClassLoader().getResource("pricesBySup.xsl");
...
Source xmlSource = new StreamSource(xmlURL.openStream(),
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(priceBySup.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
